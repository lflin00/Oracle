        ...
        {tab===MAIN_TABS.ABOUT && (
          <div style={{ maxWidth:"680px", margin:"0 auto" }}>
            ...
            <div style={{ textAlign:"center", marginTop:"2rem", paddingTop:"1.5rem", borderTop:"1px solid #1a1a25" }}>
              <a href="https://github.com/lflin00/Oracle/releases/download/v1.0.0/Oracle-1.0.0-arm64.dmg" download style={{ display:"inline-block", background:"#D4AF37", color:"#000", padding:".6rem 1.8rem", borderRadius:"6px", fontFamily:"'Cinzel',serif", fontSize:".62rem", letterSpacing:".12em", fontWeight:"bold", textDecoration:"none", marginBottom:"1rem" }}>⬇ DOWNLOAD FOR MAC</a>
